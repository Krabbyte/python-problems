...
class FamilyAgeUtils:
    ...
    def sort_by_age(self, group):    # sorts given dictionary by value
    ...
    def closest_age(group, input_age):      # finds the closest age in given dictionary to given input
    ...
    def total_age_div_by_2(group, add_even):   # gives total value of given dictionary
        return 0
